...
int main()
{
    ...
    HashTable *second_hash = create_second_hash_table(movies);
    // HashTable *second_hash = NULL;
    ...
    while (ciclo == 0)
    {
        ...
        case 3:
            ...
            // printf("%s", name_search);
            search_movie_name(first_hash, name_search);
            break;
        case 4:
            printf("Ingrese el nombre de la pelicula:\n");
            fflush(stdin);
        ...
        case 5:
            ...
            case 0:
                ...
                scanf("%d", &id_search);
                delete_by_id_first_hash(first_hash, second_hash, id_search); // se elikmina el id
            ...
            case 1:
                ...
                delete_by_name_second_hash(second_hash, name_search); // se elimina por nombre en la primera tabla tmb
                // delete_by_name_second_hash(second_hash, name_search);
                //  printf("Segunda hash\n");
                break;
            case 2:
                printf("Saliendo\n");
